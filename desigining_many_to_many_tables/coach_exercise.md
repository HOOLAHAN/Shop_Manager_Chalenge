...
CREATE TABLE posts_tags (
  student_id int,
  tag_id int,
  constraint fk_student_name foreign key(student_id) references students(id) on delete cascade,
  constraint fk_tag_name foreign key(tag_id) references tags(id) on delete cascade,
